...
#define IAVF_FLAG_AQ_GET_MAX_RSS_QREGION		BIT_ULL(42)
...
#define IAVF_EXTENDED_CAP_SEND_RSS_QREGION		BIT_ULL(2)
#define IAVF_EXTENDED_CAP_RECV_RSS_QREGION		BIT_ULL(3)
