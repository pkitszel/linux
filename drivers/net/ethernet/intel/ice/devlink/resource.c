...
static void ice_devl_res_register(struct devlink *devlink,
				  ...
				  struct device *dev_logger, void *occ_priv)
{
					      ...
					      struct devlink *devlink)
{
	...
	ice_devl_res_register(devlink, adapter->resources, pf_dev, adapter);
	devl_unlock(devlink);
}
...
void ice_devl_pf_resources_register(struct ice_pf *pf)
{
	...
	ice_devl_res_register(devlink, pf_resources, ice_pf_to_dev(pf), pf);
}
...
void ice_devlink_vf_resources_register(struct ice_vf *vf)
{
	...
	scoped_guard(devl, devlink)
		ice_devl_res_register(devlink, vf_resources, devlink_to_dev(devlink), vf);
}
